...
logger = logging.getLogger("vision.cajas")
...
class CajasPipeline(BasePersistPipeline):
    def __init__(self, source_id: int, source_path: str, func_state: dict,
        ...
        self._init_persistence("cajas", source_id)
    ...
    def start(self) -> None:
        ...
        self._thread = threading.Thread(
            ...
            name=f"cajas-pipe-{self.source_id}",
        )
        self._thread.start()
...
class CajasManager:
    _instance: Optional["CajasManager"] = None
    _class_lock = threading.Lock()

    def __init__(self) -> None:
        self.pipelines: Dict[int, CajasPipeline] = {}
        self._lock = threading.Lock()

    @classmethod
    def get(cls) -> "CajasManager":
        with cls._class_lock:
            if cls._instance is None:
                cls._instance = CajasManager()
